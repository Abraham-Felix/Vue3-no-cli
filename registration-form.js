const RegistrationForm = {
  ...
  <form autocomplete="off" class="needs-validation" novalidate >
    ...
    <div v-if="addressSameChecked === false">
      <div class="mt-3">
        <text-input label="Mailing Address" name="mailing address"  type="text" ></text-input>
        <text-input label="Mailing City/Town" name="Mailing city"  type="text" ></text-input>
        <text-input label="Mailing State/Province" name="Mailing province"  type="text" ></text-input>
        <text-input label="Mailing Zip/Postal" name="Mailing zip"  type="text" ></text-input>
      </div>
    </div>
